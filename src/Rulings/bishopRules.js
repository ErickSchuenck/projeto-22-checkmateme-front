import { checkWhatKindOfDiagonalThisIs, isADiagonal, BishopOrQueenIsCollidingWithAPiece, IsCapturingAPieceOfSameColor } from "./utils";

export function bishopRules(previousX, previousY, newX, newY, boardState, colorOfPiece) {
