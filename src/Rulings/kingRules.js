...
export function kingRules(
  ...
  if (isADiagonal(previousX, previousY, newX, newY)) {
    ...
    const kingDiagonalIsMovingASingleSquare = kingDiagonalMovementIsMatching(
      previousX,
      newX,
      previousY,
      newY,
    ...
    if (
      !isMovingSingleSquareInRowOrColumn(
        movingAxis,
        previousX,
        newX,
        previousY,
  ...
  if (
    !isADiagonal(previousX, previousY, newX, newY) &&
    !isARowOrColumn(previousX, previousY, newX, newY)
  ) {
    return false;
  }
...
function kingDiagonalMovementIsMatching(
  previousX,
  newX,
  previousY,
  newY,
...
function isMovingSingleSquareInRowOrColumn(
  movingAxis,
  previousX,
  newX,
  previousY,
