import { checkWhatKindOfDiagonalThisIs, IsCapturingAPieceOfSameColor, RookOrQueenIsCollidingWithAPiece, isADiagonal, BishopOrQueenIsCollidingWithAPiece } from "./utils";

export function queenRules(previousX, previousY, newX, newY, boardState, colorOfPiece) {
  let movingAxis;
